...
exports.sendOrderEmail =
  exports.sendVerificationUser =
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const response = yield email_config_1.transporter.sendMail({
        ...
        html: emaleTemplate_1.Verification_Email_Template.replace(
          "{verificationCode}",
          verificationCode
        ),
      });
...
const sendVerificationUser = (email, verificationCode) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const response = yield email_config_1.transporter.sendMail({
        from: 'Leather For Luxury""<overseasreshan@gmail.com>',
        ...
        html: emaleTemplate_1.Verification_User_Template.replace(
          "{verificationCode}",
          verificationCode
        ),
      });
...
const sendOrderEmail = (email, Items, structuredOrderItems) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const emailHTML = orderEmailTemplate_1.Order_Email_Template.replace(
        "{orderItems}",
        orderItemsHTML
