...
exports.Welcome_Email_Template = exports.Verification_User_Template = exports.Verification_Email_Template = void 0;
...
`;
exports.Verification_User_Template = `
  <!DOCTYPE html>
  <html lang="en">
  <head>
      <meta charset="UTF-8">
  ...
  <body>
      <div class="container">
          <div class="header"> Your Order Track Code</div>
          <div class="content">
              <p>Hello,</p>
              <p>Thank you for your order! You can track your order using the code below:</p>
              <span class="track-code">{verificationCode}</span>
