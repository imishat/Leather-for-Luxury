...
ParentCategorySchema.pre("save", function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        if (this.isModified("name") || this.isNew) {
            ...
            while (yield exports.ParentCategory.findOne({ slug: uniqueSlug }) // Correct model name
            ) {
                counter += 1;
...
exports.ParentCategory = mongoose_1.default.model("ParentCategory", ParentCategorySchema);
