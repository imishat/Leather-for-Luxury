...
const createUSer = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (!payload.location) {
        ...
        payload = Object.assign(Object.assign({}, payload), { verificationToken });
    }
    const result = yield Users_model_1.User.create(payload);
    // If location exists, send a verification email
    if (!payload.location && (result === null || result === void 0 ? void 0 : result.email) && payload.verificationToken) {
        yield (0, email_1.sendVerificationUser)(payload.email, payload.name, payload.password);
    }
    return result;
});
