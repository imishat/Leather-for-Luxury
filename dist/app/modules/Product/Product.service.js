...
const getSingleBySlug = (slug) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield Product_model_1.Product.findOne({ slug }).populate(
      "categoryId"
    ); // Query by the 'slug' field
    return result;
  });
...
const updateProductId = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
