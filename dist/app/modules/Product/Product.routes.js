...
router.patch("/update/:id", Product_controller_1.ProductController.updateProductById);
router.delete("/delete/:id", Product_controller_1.ProductController.deleteProduct);
router.post("/rating", Rating_controller_1.RatingController.createRating);
