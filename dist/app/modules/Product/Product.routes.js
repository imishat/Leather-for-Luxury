...
router.patch("/update/:id", (0, auth_1.default)(users_1.ENUM_USER_ROLE.ADMIN), Product_controller_1.ProductController.updateProductById);
router.delete("/delete/:id", 
// auth(ENUM_USER_ROLE.ADMIN),
Product_controller_1.ProductController.deleteProduct);
router.post("/rating", (0, validateRequest_1.default)(Rating_validation_1.RatingZODSchema), (0, auth_1.default)(users_1.ENUM_USER_ROLE.USER), Rating_controller_1.RatingController.createRating);
