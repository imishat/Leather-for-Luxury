...
const createProduct = (0, catchAsync_1.catchAsync)((req, res) =>
...
const getSingleProductBySlug = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getSingleProductById = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
exports.updateProductById = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params; // Extract ID from request parameters
    const updateData = req.body; // Extract update payload from request body
    // Perform the update operation
    const updatedCategory =
      yield Product_service_1.ProductService.updateProductId(id, updateData);
...
const getAll = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      Product_constants_1.ProductFilterableFields
    );
...
const deleteProduct = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const id =
      ...
      _a === void 0
        ? void 0
        : _a.id;
    const result = yield Product_service_1.ProductService.deleteProductFromDB(
      id
    );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
...
const getAllUniqueColor = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
