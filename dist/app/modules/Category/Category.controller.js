...
const createCategory = (0, catchAsync_1.catchAsync)((req, res) =>
...
const getSingleCategoryBySlug = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield Category_service_1.CategoryService.getSingleBySlug(
      slug
    );
...
const getSingleCategoryById = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getParent = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // console.log(req.params.id);
    const id = req.params.id;
...
exports.updateCategoryById = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params; // Extract ID from request parameters
    const updateData = req.body; // Extract update payload from request body
    // Perform the update operation
    const updatedCategory =
      yield Category_service_1.CategoryService.updateCategoryId(id, updateData);
...
const deleteCategory = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
