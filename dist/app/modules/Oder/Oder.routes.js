...
router.post("/create-oder", (0, validateRequest_1.default)(Oder_validation_1.OrderValidation.OrderZodSchema), Oder_controller_1.OderController.createOder);
router.get("/ById/:id", Oder_controller_1.OderController.getSingleOrderById);
