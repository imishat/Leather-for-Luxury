...
const createOder = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Create the order
    const result = yield Oder_model_1.Order.create(
...
const updateOrderId = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getAll = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { startDate, endDate, searchTerm } = filters,
      filtersData = __rest(filters, ["startDate", "endDate", "searchTerm"]);
    const andConditions = [];
