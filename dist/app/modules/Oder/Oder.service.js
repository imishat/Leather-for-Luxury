...
const getSingleById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield Oder_model_1.Order.findById(id)
        .populate("user")
        .populate({
        path: "orderItems",
        populate: {
...
const getOderByUser = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield Oder_model_1.Order.find({ user: id });
    return result;
});
